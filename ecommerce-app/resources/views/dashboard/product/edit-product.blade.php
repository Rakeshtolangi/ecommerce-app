        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                ...
                <div class="ms-md-auto py-2 py-md-0">
                    ...
                    <a href="#" class="btn btn-primary btn-round">Edit Product</a>
                </div>
                            ...
                            <div class="mb-4 border rounded p-3">
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="number" value = "{{ $product->price }}" step="0.01" name="price"
                                            class="form-control" value="0.00">
                                    </div>

                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Sale Price ($) (Optional)</label>
                                        <input type="number" value = "{{ $product->sale_price }}"step="0.01"
                                            name="sale_price" class="form-control" value="0.00">
                                    </div>
